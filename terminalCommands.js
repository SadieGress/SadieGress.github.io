export function loadTerminal(textBox) {
    ...
    <a href="/art">[ART]</a><br>
    <a href="/media">[MEDIA BLOG]</a><br>
    <a href="/writing">[WRITING]</a><br>
    <a href="/fishing">[FISHING MINIGAME]</a><br><br>
...
let versionMap = {
    "1.0.4":`
    - Art page/galeery upload<br>
    - cd command (in progress! only cd art available.)<br>
    - Fixed issue with non-commands raising an error. 
    `,
    "1.0.3":`
...
export function helptext() {
    ...
    cd &ltdir&gt: go to directory.<br>
...
export function cd(dir) {
    const dirs = Object.create(null, {
        "art": { value: "/art", enumerable: true },
        "media": { value: "/media", enumerable: true },
        "writing": { value: "/writing", enumerable: true },
        "fishing": { value: "/fishing", enumerable: true }
      });
    
    if (Object.hasOwn(dirs, dir)) {
        window.location.href = dirs[dir];
